...
config :routine, RoutineWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "ZSImErqXTu/q1Cna8LxZyZbhC7hyXyhzeor0kMkpTQp7Kml2kF3gIdzd5INjJd2N",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:routine, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:routine, ~w(--watch)]}
  ]
...
config :routine, RoutineWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/routine_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :routine, dev_routes: true
